...
5. Plan đang chạy duy nhất: `plans/backend-solid-refactor.md` (nhánh `refactor/backend-solid`, 8 module teams; plans cũ đã đóng hết vào `plans/done/` 2026-09-22)
6. `plans/modules/M<n>-<name>.md` — plan từng module (đã done cả 8, kèm close-out evidence)
